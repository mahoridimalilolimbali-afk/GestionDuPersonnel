...
# Charger les variables d'environnement (doit être au début)
...
# Optionnel : Créez automatiquement le dossier s'il n'existe pas
...
SECRET_KEY = 'django-insecure-a^1i1@21-+hf1)h5%n)385b2@wgan2%v(8ir5^-_1dl@kxk_qv'
